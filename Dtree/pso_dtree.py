...
class PSO:
    ...
    def performace(self, pos):
        ...
        valor = pos[1]
        arvore = DecisionTreeClassifier(max_depth= int(pos[0]), criterion= criterion_dic[int(valor)], min_samples_split=pos[2])
    ...
    def executar(self):
        ...
        with open ('PSO_RESDtree.txt', 'w') as file:
        ...
        print("\n\n")
        with open ('PSO_RESDtree.txt', 'a') as file:
